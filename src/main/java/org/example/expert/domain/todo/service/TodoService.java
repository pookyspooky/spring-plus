...
public class TodoService {
    ...
    public Page<TodoResponse> getTodos(String weather, LocalDateTime startDate, LocalDateTime endDate, int page, int size) {
        ...
        Page<Todo> todos = todoRepository.findByWeatherAndModifiedAt(weather, startDate, endDate, pageable);
    ...
    public Page<TodoSearchDto> search(
        ...
        Pageable pageable = PageRequest.of(page - 1, size);
        return todoRepository.search(title, managerNickname, startDate, endDate, pageable);
    }
}
